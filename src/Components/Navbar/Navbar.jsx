...
const Header = () => {
  ...
  const displayProfilePic = userData?.profilePic || defaultImage;
              ...
              {userData ? (
                <Dropdown className="me-5 mt-1">
                  ...
                  <Dropdown.Menu align="end">
                    <Dropdown.Item>
                      <Image
                        src={displayProfilePic} alt="User Avatar" height="25px" width="25px" roundedCircle className="mx-auto mt-2 mb-1" />
                    </Dropdown.Item>
...
//   const displayUsername = userData?.userName || userData?.username || 'User';
//   const displayProfilePic = userData?.profilePic || defaultImage;
...
//             <h2>
//               <div className="d-flex justify-content-center gap-1">
//                 <i className="fa-solid fa-burger fa-xs fs-1 mt-3" style={{ color: "#FE0C00" }}></i>
//                 <div>
//                   <span style={{ color: "#FE0C00" }}> <b>B</b>ite</span><span className="text-gray-700 " style={{ fontWeight: '500' }}>Box</span>
//                 </div>
//               </div>
